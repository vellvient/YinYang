// content.js
// Guard against double-injection (happens when extension is reloaded while tab is open)
if (window.__yinyangLoaded) {
    console.log("YinYang: already loaded in this tab, skipping re-injection.");
} else {
    window.__yinyangLoaded = true;
